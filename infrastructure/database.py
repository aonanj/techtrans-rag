...
class Document(Base):
    ...
    doc_type = Column(String(512), nullable=True)
    jurisdiction = Column(String(512), nullable=True)
    governing_law = Column(String(512), nullable=True)
    party_roles = Column(String(512), nullable=True)
